...
/**
 *	顺德公安 <font> 伪造车牌号码 </font> 审讯
 */
@Controller
@RequestMapping("/forgedLicensePlate")
public class ForgedLicensePlateController {

	private static final Logger log = LoggerFactory.getLogger(ForgedLicensePlateController.class);
	...
	public Object getAnswer(@RequestBody String json) {
		...
		try {
			...
			log.info("/t ****** 伪造车牌号码问答接口参数：\t"+paramMap);
