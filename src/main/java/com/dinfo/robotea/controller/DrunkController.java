...
/**
 *	顺德公安 <font> 酒驾 </font> 审讯
 */
@Controller
@RequestMapping("/drunk")
public class DrunkController {

	private static final Logger log = LoggerFactory.getLogger(DrunkController.class);
	...
	private final static  String question18_1="当时你是否在从事营运？";
...
//				nextQuestion=question5_01;
			...
			Map map = algorithmService.algorithmElementsOfCase(question);
			Map<String,Object> mapError = (Map<String,Object>) map.get("wahsterror");
			...
			if(mapError!=null){
				...
				for(Map.Entry<String,Object> entry: mapError.entrySet()){
...
//						}
            ...
            Map map = algorithmService.algorithmElementsOfCase(question);
            String blood = (String) map.get("alcoholdetect");
            ...
            if(StringUtils.containsAny(humanResponse,"不","没")){
				...
				nextQuestion = question18_1;

			}



        }else if(StringUtils.contains(question,question18_1)){
			redisUtil.lSet(wholeQuestions,question); // 记录笔录
...
//		log.info("下一个问题是：\t"+nextQuestion);
	...
	public String generateQuestion8(Map<String,Object> paramMap,String reportSummaryx){
		...
		StringBuilder tempQuestion8 = new StringBuilder("");

		String familyInfoa = (String)paramMap.get("familyInfo");
		if(StringUtils.isNotBlank(familyInfoa)){
			tempQuestion8.append(familyInfoa);
		}

		redisUtil.hset(reportSummaryx,"familyInfo",StringUtils.isBlank(familyInfoa)?"":familyInfoa);


		tempQuestion8.append(question8);


		return  tempQuestion8.toString();
   ...
   /**
	...
	public String generateQuestion15(Map<String,Object> paramMap,String reportSummaryx){
		...
		/*		TimeOfCrime : "2019-11-13 20:35:54" --->  2019年11月13日20点",
