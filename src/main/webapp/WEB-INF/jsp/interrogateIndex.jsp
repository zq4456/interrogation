        ...
        <div class="dialogue-header">
            ...
            <div class="dialogue-service-info">
                ...
                <div class="dialogue-service-title">
                    ...
                    <p class="dialogue-service-detail">机器人审讯问答演示平台</p>
                </div>
            </div>
        </div>
        <div id="dialogue_contain" class="dialogue-contain">
            <p class="dialogue-service-contain">
            <span class="dialogue-text dialogue-service-text">我们是广东省佛山市顺德区公安局民警，现就有关案情依法对你进行讯问并进行录音录像，你必须如实回答，不得隐瞒事实或者作假口供，不得诬告及陷害他人，否则要负相应的法律责任，对与本案无关的问题你有权拒绝回答的权利，你知道吗？
            </span>
            </p>
            ...
            success: function (result) {
                ...
                if ( nextQ && nextQ!="审讯完毕" ) {
                    if (nextQ !== null || nextQ !== undefined || nextQ !== '') {
                        ...
                        //  刷新 ”审讯要素“模块
                         $.ajax({
                                    url: '${ctx}/interrogate/getElement',
                                    type: "POST",
                                    dataType: "json",
                                    data: {
                                    	cookieUuid: cookieUuid
