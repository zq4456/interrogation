        ...
        <div class="dialogue-header">
            ...
            <div class="dialogue-service-info">
                ...
                <div class="dialogue-service-title">
                    ...
                    <p class="dialogue-service-detail">无证驾驶审讯</p>
                </div>
            </div>
        </div>
...
<script>
    ...
    function getServiceText(answer) {
       /*  var serviceText = data.robot.dialogue,
        ...
        // 问答接口响应
        $.ajax({
            url: '${ctx}/drivingWithoutLicense/getAnswer',
            type: "POST",
            ...
            data:JSON.stringify({
                   ...
                   resumeInfo:"2015年毕业于南京大学建筑系,2016年就职于郑州市体育局,2018你就职于济南市卫生局", // 个人简历
                   familyInfo:"我的父亲叫李振,54岁,我的母亲叫王雅君,40岁;我的妻子叫陶琳琳", // 家庭状况
            ...
            success: function (result) {
                ...
                if ( nextQ && nextQ!="审讯完毕" ) {
                    if (nextQ !== null || nextQ !== undefined || nextQ !== '') {
                        ...
                        //  刷新 ”审讯笔录“模块  TODO
                        $.ajax({
                                url: '${ctx}/drivingWithoutLicense/getRecord',
                                type: "POST",
                                dataType: "json",
                                data: {
                                    cookieUuid: cookieUuid
                        ...
                        //  刷新 ”审讯要素“模块
                         $.ajax({
                                    url: '${ctx}/drivingWithoutLicense/getElement',
                                    type: "POST",
                                    dataType: "json",
                                    data: {
                                    	cookieUuid: cookieUuid
